...
const categories = [
  { id: 'all', name: 'All Projects', icon: Home, count: 45 },
  { id: 'file-operations', name: 'File Operations', icon: FileText, count: 12 },
  { id: 'web-tools', name: 'Web Tools', icon: Globe, count: 8 },
  { id: 'security', name: 'Security Tools', icon: Shield, count: 7 },
  { id: 'utilities', name: 'Utility Tools', icon: Wrench, count: 10 },
  { id: 'multimedia', name: 'Multimedia', icon: Image, count: 8 },
];
